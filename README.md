About sound_field_analysis-feedstock
====================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sound_field_analysis-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4738&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sound_field_analysis-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sound_field_analysis` can be installed with `conda`:
...
```
mamba install sound_field_analysis
```

It is possible to list all of the versions of `sound_field_analysis` available on your platform with `conda`:
...
```
mamba search sound_field_analysis --channel conda-forge
```
...
mamba repoquery search sound_field_analysis --channel conda-forge

# List packages depending on `sound_field_analysis`:
mamba repoquery whoneeds sound_field_analysis --channel conda-forge

# List dependencies of `sound_field_analysis`:
mamba repoquery depends sound_field_analysis --channel conda-forge
```
